  ...
  array (
    ...
    array (
      ...
      array (
        ...
        2 => 'База данных должна поддерживать InnoDB, utf8mb4, внешние ключи, JSON-поля и FULLTEXT-индексы. Рекомендуется MySQL 8.0 или новее либо актуальная поддерживаемая версия MariaDB. Веб-сервер должен передавать все неизвестные маршруты в public_html/index.php, принимать методы GET, POST, PATCH и DELETE, обслуживать HTTPS и разрешать загрузку CSV/XLSX.',
      ),
    ),
    1 => 
    array (
