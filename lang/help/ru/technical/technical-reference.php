...
CODE,
        ...
        [
            ...
            'paragraphs' => [
                'Поддерживаемые версии проекта — PHP 8.4 и 8.5. public_html/index.php намеренно не подключает Composer autoload на неподдерживаемой версии. Нужна MySQL-совместимая база с InnoDB, utf8mb4, внешними ключами, JSON и FULLTEXT. Рекомендуемая серверная схема — Nginx или Apache, PHP-FPM и отдельный PHP CLI той же версии.',
