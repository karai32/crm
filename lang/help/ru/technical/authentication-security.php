...
CODE,
        ...
        [
            ...
            'paragraphs' => [
                'Разрешения уже переведены на fail-closed, политики веб-маршрутов централизованы в Router, а доступ к странице ИИ и её AJAX выровнен до уровня admin. При добавлении permission по-прежнему нужна миграция явных значений для существующих пользователей. Оставшийся высокий приоритет — проверять активность и текущую роль пользователя в живой сессии и реализовать отзыв всех сессий и remember-токенов при деактивации, смене пароля или роли.',
