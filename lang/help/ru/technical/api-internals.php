...
CODE,
        ...
        [
            ...
            'paragraphs' => [
                ...
                'ContactApiService и ClientApiService не записывают основные сущности и связи напрямую: подготовленный контракт передаётся в ContactWriteService или ClientWriteService. Эти общие сервисы также используются HTML и импортом. SectorApiService и TagApiService пока сохраняют свои более простые операции непосредственно через соответствующие репозитории.',
