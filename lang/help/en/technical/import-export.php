...
CODE,
        ...
        [
            ...
            'paragraphs' => [
                'Adding a system import field requires coordinated changes to the template, ImportMapping::fields(), suggest() aliases, and the corresponding processor. A new entity requires its own processor, permitted entity_type in every controller and manager, an ENUM value or history-table migration, interface tabs, and domain tests. A file format requires upload validation, a MIME map, reader, and writer; changing only HTML accept has no server effect.',
