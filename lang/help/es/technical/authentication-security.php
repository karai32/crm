...
CODE,
        ...
        [
            ...
            'paragraphs' => [
                'Los permisos ya aplican fail-closed, las políticas de las rutas web están centralizadas en Router y el acceso a la página de IA y a su AJAX está alineado con el nivel admin. Al añadir un permission sigue siendo necesaria una migración de valores explícitos para los usuarios existentes. La prioridad alta pendiente es comprobar la actividad y el rol actual del usuario en una sesión viva, y revocar todas las sesiones y tokens remember-me cuando se desactive la cuenta o se cambien la contraseña o el rol.',
