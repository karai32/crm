...
public_html/index.php                    # require_once, objeto y rutas',
    ...
    array (
      ...
      array (
        ...
        1 => 'El proyecto no utiliza modelos de Eloquent ni dispone de un runner automático de migraciones: el acceso a datos se realiza mediante Illuminate Database Query Builder y los cambios en una base existente se aplican manualmente con archivos SQL de database/migrations. database/schema.sql está destinado a la primera instalación y no es una migración. Todavía no existe un directorio de pruebas automatizadas, por lo que los cambios se comprueban mediante PHP lint, flujos de la interfaz y la API y revisión de los registros; es recomendable cubrir gradualmente las reglas de dominio críticas con pruebas unitarias o de integración.',
