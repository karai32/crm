...
CODE,
        ...
        [
            ...
            'paragraphs' => [
                'Para añadir un campo del sistema a la importación hay que actualizar conjuntamente la plantilla, ImportMapping::fields(), los alias de suggest() y el procesador correspondiente. Una entidad nueva requiere un procesador independiente, un entity_type permitido en todos los controladores y managers, un valor ENUM o un cambio manual de las tablas de historial, pestañas en la interfaz y pruebas del dominio. Un formato de archivo se añade mediante la validación de carga, el mapa MIME, el reader y el writer; ampliar únicamente accept en el HTML no modifica el comportamiento del servidor.',
