...
<div class="import-result-actions">
    <a class="btn btn-primary" href="<?= htmlspecialchars(Auth::url('/contacts'), ENT_QUOTES, 'UTF-8') ?>">
    ...
    <?php if (!empty($result['batch']['id']) && (int) $result['errors'] > 0): ?>
        <a class="btn btn-outlined" href="<?= htmlspecialchars(Auth::url('/imports/errors?id=' . $result['batch']['id']), ENT_QUOTES, 'UTF-8') ?>">View errors</a>
    <?php endif; ?>
