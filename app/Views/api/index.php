...
$toc = [
    ['id' => 'keys',     'label' => 'API Keys',      'accent' => 'violet',
...
function apiCardHead(array $item): void { ?>
...
function apiCodeBlock(string $label, string $id, string $code): void { ?>
    <div class="api-code-wrap">
        <div class="api-code-header">
            ...
            <button class="api-code-copy" onclick="
                navigator.clipboard.writeText(document.getElementById('<?= htmlspecialchars($id, ENT_QUOTES, 'UTF-8') ?>').textContent).then(function(b){
...
<div class="page-header settings-header" style="margin-bottom:20px">
    ...
    <span style="font-size:13px;color:var(--color-text-muted)">Base URL: <code style="background:var(--color-neutral-100);padding:2px 7px;border-radius:4px;font-size:12px"><?= htmlspecialchars($apiBase, ENT_QUOTES, 'UTF-8') ?></code></span>
</div>

<!-- New key reveal banner -->
<?php if (!empty($newKey)): ?>
<div class="api-key-reveal" style="margin-bottom:20px">
...
<div class="help-layout">
    ...
    <div class="help-content">
        ...
        <!-- ══════════════════════════════════════════ API KEYS ══ -->
        <section class="help-card" id="keys">
            <?php apiCardHead($toc[0]); ?>
                    API key management
                </div>
            </div>
            ...
            <div class="help-card-body">
                ...
                <!-- Create form -->
                <p class="api-label">Create new key</p>
                <form method="post" action="<?= htmlspecialchars(Auth::url('/api-keys/store'), ENT_QUOTES, 'UTF-8') ?>">
                    <?= Csrf::field() ?>
                    <div style="display:flex;gap:12px;align-items:flex-end;flex-wrap:wrap;margin-bottom:16px">
                        <div class="field" style="flex:1;min-width:200px;margin:0">
                            <label for="keyName" style="font-size:12px;font-weight:600;color:var(--color-text-muted);margin-bottom:5px;display:block">Key name <span style="color:var(--color-danger)">*</span></label>
                    ...
                    <p style="font-size:12px;color:var(--color-text-muted);margin:6px 0 0">All new keys receive these scopes by default.</p>
                </form>

                <!-- Keys table -->
                <?php if (!empty($apiKeys)): ?>
                <div class="api-card-divider" style="margin-top:20px"></div>
                <p class="api-label">Existing keys</p>
                ...
                <?php else: ?>
                <p style="color:var(--color-text-muted);font-size:13.5px;margin-top:20px">No keys yet. Generate one above to start using the API.</p>
                <?php endif; ?>
            </div>
        </section>
        ...
        <section class="help-card" id="auth">
            ...
            <div class="help-card-body">
                ...
                <?php apiCodeBlock('HTTP', 'ex-auth', '<span class="ch">X-API-KEY</span>: <span class="cs">crm_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</span>'); ?>

                <p class="api-label" style="margin-top:20px">PowerShell example</p>
                <?php apiCodeBlock('PowerShell', 'ex-ps', <<<"CODE"
...
CODE); ?>
                ...
                <div class="api-resp-shape">
                    <?php apiCodeBlock('Success', 'ex-resp-ok', <<<"CODE"
{
  <span class="ck">"success"</span>: <span class="cn">true</span>,
  <span class="ck">"data"</span>: { ... }
}
CODE); ?>
                    <?php apiCodeBlock('Error', 'ex-resp-err', <<<"CODE"
{
...
CODE); ?>
        ...
        <section class="help-card" id="contacts">
            ...
            <div class="help-card-body">
                ...
                <p style="font-size:12px;color:var(--color-text-muted);margin:0 0 0">
                ...
                <?php apiCodeBlock('POST /api/v1/contacts', 'ex-contacts-post', <<<"CODE"
[
  {
  ...
  {
    <span class="ck">"first_name"</span>: <span class="cs">"Anna"</span>,
    <span class="ck">"email"</span>:      <span class="cs">"anna@example.com"</span>,
    <span class="ck">"tag"</span>:        <span class="cs">"Lead"</span>,
    <span class="ck">"client"</span>:     <span class="cs">"Beta LLC"</span>
  }
]
CODE); ?>

                <p class="api-label" style="margin-top:16px">Example — response (207)</p>
                <?php apiCodeBlock('Response', 'ex-contacts-207', <<<"CODE"
{
  <span class="ck">"success"</span>: <span class="cn">true</span>,
  <span class="ck">"data"</span>: {
    <span class="ck">"processed"</span>: <span class="cn">2</span>, <span class="ck">"created"</span>: <span class="cn">2</span>, <span class="ck">"failed"</span>: <span class="cn">0</span>,
    <span class="ck">"results"</span>: [
      ...
      { <span class="ck">"index"</span>: <span class="cn">1</span>, <span class="ck">"success"</span>: <span class="cn">false</span>, <span class="ck">"error"</span>: { <span class="ck">"code"</span>: <span class="cs">"duplicate_contact"</span>, <span class="ck">"message"</span>: <span class="cs">"..."</span> } }
    ]
  }
}
CODE); ?>
                ...
                <?php apiCodeBlock('PATCH /api/v1/contacts/42', 'ex-contacts-patch', <<<"CODE"
{
...
CODE); ?>
        ...
        <section class="help-card" id="clients">
            ...
            <div class="help-card-body">
                ...
                <?php apiCodeBlock('POST /api/v1/clients', 'ex-clients-post', <<<"CODE"
[
  {
...
CODE); ?>
                ...
                <?php apiCodeBlock('Response', 'ex-clients-get', <<<"CODE"
{
  <span class="ck">"success"</span>: <span class="cn">true</span>,
  <span class="ck">"data"</span>: {
...
CODE); ?>
        ...
        <section class="help-card" id="sectors">
            ...
            <div class="help-card-body">
                ...
                <?php apiCodeBlock('POST /api/v1/sectors', 'ex-sectors-post', <<<"CODE"
...
CODE); ?>
                ...
                <?php apiCodeBlock('Response', 'ex-sectors-del', <<<"CODE"
...
CODE); ?>
        ...
        <section class="help-card" id="tags">
            ...
            <div class="help-card-body">
                ...
                <?php apiCodeBlock('POST /api/v1/tags', 'ex-tags-post', <<<"CODE"
[
