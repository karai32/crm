...
<div class="settings-form-card" style="margin-bottom:24px">
    <form method="post" action="<?= htmlspecialchars(Auth::url('/api-keys/store'), ENT_QUOTES, 'UTF-8') ?>">
        ...
        <div class="settings-form-body">
            ...
            <div class="field">
                <label>Scopes</label>
                <div style="display:flex;align-items:center;gap:8px;padding:8px 12px;background:var(--color-neutral-50);border:1px solid var(--color-neutral-200);border-radius:var(--radius-sm);width:fit-content">
                    ...
                    <span style="font-size:13px;font-weight:500">contacts:write</span>
                </div>
