...
<div class="page-header clients-header">
    <div>
        <h1><?= t('clients.create_title') ?></h1>
        <span class="count-label"><?= t('clients.fill_fields') ?></span>
    </div>
    <div class="page-actions">
        <a class="btn btn-outlined" href="<?= htmlspecialchars(Auth::url('/clients'), ENT_QUOTES, 'UTF-8') ?>"><?= t('common.cancel') ?></a>
    </div>
</div>
...
<form method="post" action="<?= htmlspecialchars(Auth::url('/clients/store'), ENT_QUOTES, 'UTF-8') ?>">
    ...
    <div class="client-form-card">
        ...
        <div class="form-actions">
            <button class="btn btn-primary" type="submit"><?= t('clients.create_btn_form') ?></button>
            <a class="btn btn-outlined" href="<?= htmlspecialchars(Auth::url('/clients'), ENT_QUOTES, 'UTF-8') ?>"><?= t('common.cancel') ?></a>
        </div>
