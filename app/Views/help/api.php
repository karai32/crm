        ...
        <table class="api-fields">
            ...
            <tbody>
                <tr>
                    ...
                    <td><span class="api-badge-req">required</span></td>
                    <td>Full name</td>
                </tr>
                <tr>
                    ...
                    <td>Unique email address when provided</td>
                </tr>
                <tr>
                    <td><code>tags</code></td>
                    <td><span class="api-type">string|string[]</span></td>
                    <td><span class="api-badge-opt">optional</span></td>
                    <td>One or more tag names — single name, comma-separated string, or array. Created if missing.</td>
                </tr>
                <tr>
                    <td><code>clients</code></td>
                    <td><span class="api-type">string|string[]</span></td>
                    <td><span class="api-badge-opt">optional</span></td>
                    <td>One or more client commercial names — single name, comma-separated string, or array. Created if missing.</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><span class="api-type">string</span></td>
                    <td><span class="api-badge-opt">optional</span></td>
                    <td>Company name, or empty string if not a company</td>
                </tr>
                <tr>
                    <td><code>custom_fields</code></td>
                    <td><span class="api-type">object</span></td>
                    <td><span class="api-badge-opt">optional</span></td>
                    <td>Key/value pairs by field slug. Unknown slugs are ignored. Flat <code class="help-api-inline-code">"custom_fields.&lt;slug&gt;"</code> keys work the same way, on both POST and PATCH.</td>
                </tr>
            </tbody>
        </table>
    ...
    <section class="help-card" id="clients">
        ...
        <div class="help-card-body">
            ...
            <table class="api-fields">
                ...
                <tbody>
                    <tr>
                        <td><code>commercial_name</code></td>
                        <td><span class="api-type">string</span></td>
                        <td><span class="api-badge-req">required</span></td>
                        <td>Commercial / trading name</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><span class="api-type">object</span></td>
                        <td><span class="api-badge-opt">optional</span></td>
                        <td>Key/value pairs by field slug. Flat <code class="help-api-inline-code">"custom_fields.&lt;slug&gt;"</code> keys work the same way, on both POST and PATCH.</td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="api-fields">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><span class="api-type">string</span></td>
                        <td><span class="api-badge-req">required</span></td>
                        <td>Sector name. Slug is auto-generated.</td>
                    </tr>
                    <tr>
                        <td><code>is_active</code></td>
                        <td><span class="api-type">boolean</span></td>
                        <td><span class="api-badge-opt">PATCH only</span></td>
                        <td>Activate or deactivate the sector</td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="api-fields">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><span class="api-type">string</span></td>
                        <td><span class="api-badge-req">required</span></td>
                        <td>Tag label. Slug is auto-generated.</td>
                    </tr>
                    <tr>
                        <td><code>color</code></td>
                        <td><span class="api-type">string</span></td>
                        <td><span class="api-badge-opt">optional</span></td>
                        <td>Hex colour, e.g. <code>#3b82f6</code>. Pass <code>null</code> to clear.</td>
                    </tr>
                </tbody>
            </table>
