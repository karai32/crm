            ...
            'es' => [
                ...
                'sections' => [
                    [
                        ...
                        'summary' => 'El CRM esta organizado en modulos accesibles desde el menu lateral. El flujo habitual es: crear contactos → vincularlos a clientes → clasificarlos con tags → filtrar y exportar cuando lo necesites.',
                        'items'   => [
                            'El <strong>Dashboard</strong> ofrece una vista rapida de totales, actividad reciente y accesos directos.',
                            'El <strong>menu lateral</strong> da acceso a Contacts, Clients, Sectors, Tags y la seccion de configuracion.',
                            'La <strong>barra de busqueda superior</strong> busca contactos y clientes en tiempo real por nombre, email o empresa.',
                            'El <strong>menu de perfil</strong> (esquina superior derecha) muestra tu nombre y permite cerrar sesion.',
                        ],
                        'tip' => 'Empieza creando algunos contactos y un par de clientes. Luego vincularlos y aplicar tags te dara una base solida para explorar los filtros y las exportaciones.',
                    ],
                    [
                        'id'      => 'contacts',
                        'accent'  => 'blue',
            ...
            'en' => [
                ...
                'sections' => [
                    [
                        ...
                        'summary' => 'The CRM is organized into modules accessible from the sidebar. The typical flow is: create contacts → link them to clients → classify with tags → filter and export when needed.',
                        'items'   => [
                            'The <strong>Dashboard</strong> gives you a quick overview of totals, recent activity, and shortcuts.',
                            'The <strong>sidebar</strong> provides access to Contacts, Clients, Sectors, Tags, and the settings section.',
                            'The <strong>top search bar</strong> finds contacts and clients in real time by name, email, or company.',
                            'The <strong>profile menu</strong> (top-right corner) shows your name and lets you log out.',
                        ],
                        'tip' => 'Start by creating a few contacts and a couple of clients. Linking them and applying tags will give you a solid base to explore filters and exports.',
                    ],
                    [
                        'id'      => 'contacts',
                        'accent'  => 'blue',
