...
if (file_exists($autoloadPath) && PHP_VERSION_ID >= 80400 && PHP_VERSION_ID < 80600) {
    try {
    ...
    error_log('Composer autoload skipped: PHP 8.4 or 8.5 is required for installed dependencies. Current PHP: ' . PHP_VERSION);
}
...
require_once __DIR__ . '/../app/Core/Strings.php';
...
$router->get('/password/forgot', [$authController, 'showForgotPassword'], $publicPolicy);
$router->post('/password/forgot', [$authController, 'sendResetLink'], $publicPolicy);
$router->get('/password/reset', [$authController, 'showResetPassword'], $publicPolicy);
$router->post('/password/reset', [$authController, 'resetPassword'], $publicPolicy);
