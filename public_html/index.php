...
$router->post('/sectors/delete', [$sectorController, 'delete']);
...
$router->post('/tags/delete', [$tagController, 'delete']);
...
$router->post('/custom-fields/delete', [$customFieldController, 'delete']);
